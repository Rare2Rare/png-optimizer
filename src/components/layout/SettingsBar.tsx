...
export function SettingsBar({
  ...
  return (
    ...
    >
      {/* Row 1: Mode, Quality, Format, Resize, Toggles */}
      <div
        style={{
          padding: "6px 16px",
          display: "flex",
      ...
      >
        ...
        {/* Quality */}
        <div style={{ display: "flex", alignItems: "center", gap: 4, opacity: settings.mode === "lossless" ? 0.4 : 1 }}>
          ...
          <input type="range" min={1} max={100} value={settings.quality}
            ...
            disabled={settings.mode === "lossless"} style={{ width: 70, accentColor: "var(--accent)" }} />
